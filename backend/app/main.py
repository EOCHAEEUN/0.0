...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "http://127.0.0.1:5177",
        "http://127.0.0.1:5178",
        "https://facto-fit-seven.vercel.app",
        "https://facto-fit.co.kr",
        "https://www.facto-fit.co.kr",
    ],
...
app.include_router(safety_check_improvement.router, prefix="/api/safety-check", tags=["safety-check-improvement"])
