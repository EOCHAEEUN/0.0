...
from app.routers import chat, industry, onboarding, safety, analyze, auth, draft, reports, documents, click_chat_two, click_chat_three
...
app.include_router(click_chat_three.router, prefix="/api", tags=["click-chat-three"])