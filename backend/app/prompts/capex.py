...
기업의 설비 정보를 바탕으로 calculate_equipment_roi 툴을 호출해 ROI를 계산하고,
아래 형식으로 시나리오 A/B 카드를 출력하세요.
...
{roi_result}
"""
# TODO: 매칭된 지원사업 연동 후 프롬프트에 추가 예정
# matched_policies 변수 agents/capex.py에서 이미 전달 중
