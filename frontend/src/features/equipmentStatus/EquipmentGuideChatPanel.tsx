  ...
  return [
    {
      ...
      role: "assistant",
      text: "아래 버튼을 누르거나 항목명을 입력하면 입력 방법을 안내해 드립니다.",
    },
  ]
}
  ...
  return createPortal(
    <>
      ...
      <div className="ff-equipment-guide-chat__scope-banner" role="note">
        <strong>안내 범위</strong>
        <p>
          이 챗봇은 아래 설비 등록·수정 폼의 입력값(설비 종류, 설비명, 사용연수, 에너지
          비용, 투자금 등)만 설명합니다. ROI·지원사업·안전·신청서 등 다른 업무 질문은
          지원하지 않습니다.
        </p>
      </div>
      ...
      <form
        className="ff-equipment-guide-chat__input"
        onSubmit={(event) => {
