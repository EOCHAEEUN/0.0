...
const safetyItems: SafetyItem[] = [
  {
    ...
    score: 72,
    tone: "orange",
    description: "프레스 설비 사용연수 11년으로 정밀점검 권고 구간에 진입했습니다.",
  },
  {
    label: "유지보수 이력",
    status: "주의",
...
function getStatusBadgeClass(tone: "green" | "orange" | "red") {
        ...
        <div className="container">
          ...
          <div className="section-head">
            ...
            <p className="section-desc">
              설비 사용연수, 유지보수 이력, 불량률, 안전장치 상태를 바탕으로
              점검 우선순위와 교체 필요성을 함께 판단합니다.
            </p>
          </div>
          ...
          <div className="safety-summary-grid">
            <div className="safety-score-card">
              ...
              <p>
                즉시 중단이 필요한 수준은 아니지만, 사용연수와 유지보수비 증가,
                불량률 변화를 고려하면 정밀점검과 설비 교체 검토가 필요한
                상태입니다.
              </p>
          ...
          >
            ...
            >
              <div>
                <span className="badge orange">정밀점검 권고</span>
                ...
                <p>
                  설비 사용연수 11년, 불량률 5.8%, 유지보수비 증가 흐름을
                  종합하면 단순 수리보다 교체 또는 고도화 투자 검토가 더
                  적합할 수 있습니다.
                </p>
              </div>
                ...
                >
                  {safetyItems.map((item) => (
                    ...
                    >
                      ...
                      >
                        <div>
                          <span className={`badge ${getStatusBadgeClass(item.tone)}`}>
                            {item.status}
                          </span>
              ...
              <div className="detail-body">
                <div className="scenario-grid">
                  <div className="scenario best">
                    ...
                    <p>
                      현재 프레스 설비는 사용연수 증가, 유지보수비 상승, 불량률
                      증가가 동시에 나타나고 있습니다. 단순 수리보다 고효율
                      설비 교체와 스마트 모니터링 시스템 도입을 함께 검토하는
                      것이 적합합니다.
                    </p>
                  ...
                  <div className="scenario">
                    ...
                    <p>
                      안전 리스크와 설비 노후도는 단순 내부 관리 문제가 아니라
                      설비 교체 지원사업의 신청 근거가 될 수 있습니다. ROI
                      분석과 함께 제시하면 사업계획서 설득력이 높아집니다.
                    </p>
